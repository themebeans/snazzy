...
class Snazzy_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'bean_flickr',
			esc_html__( 'Flickr Photos', 'snazzy' ),
			array( 'description' => esc_html__( 'Add a Flickr feed widget.', 'snazzy' ) )
		);
	}
...
<p><?php echo balanceTags( $desc ); ?></p><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title / Intro:', 'snazzy' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'flickrID' ) ); ?>"><?php _e( 'Flickr ID:', 'snazzy' ); ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php _e( 'Type:', 'snazzy' ); ?></label>
...
>Group</option>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php _e( 'Display:', 'snazzy' ); ?></label>
